...
export const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose, onLogin, onSignup, users }) => {
  ...
  const handleGoogleLogin = () => {
    ...
    // In a real app, this would trigger Firebase/OAuth popup
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-sm rounded-2xl shadow-2xl p-6 animate-in fade-in zoom-in duration-300 overflow-hidden">
        ...
        <button 
          ...
          className="w-full bg-white border border-gray-200 text-gray-700 py-3 rounded-xl font-bold hover:bg-gray-50 transition-colors flex items-center justify-center gap-3 shadow-sm hover:shadow-md"
        >
          <GoogleIcon />
          Google
        </button>
